...
function Home() {
  return (
    <div>
      <div className="bg-hero bg-repeat-x ">
        <Nav />
        <div className="grid grid-cols-5">
          <div className="col-span-3 flex justify-center items-center">
            <div className="max-w-[667px]  ">
              <h1 className="text-5xl text-white/90 font-bold leading-[62px]">
          ...
          {/* <div className="relative col-span-2 justify-self-end">
            <img src={imgLines} alt="image" className="" />
            <img
              src={heroImg}
              alt="image"
      ...
      <section className="py-[52px] max-w-[1284px] mx-auto">
        <div className="mx-10">
          <div className="flex justify-between mb-12">
            <h2 className="text-[#002D72] text-4xl font-semibold">
      ...
      <section className="bg-promise bg-cover h-screen bg-no-repeat flex items-end relative">
        <div className="w-[811px] bg-white rounded-tr-[170px] py-[52px] px-24">
          {/* <> */}
          <h2 className="text-[#002D72] font-semibold text-5xl leading-[60px] mb-[19px]">
      ...
      <section className="bg-feature bg-cover pt-[36px] pb-[60px] text-center ">
        ...
        <div className="flex gap-[107px] container mx-auto mb-[57px]">
      ...
      <section>
        <div className="container mx-auto">
          <div className="grid grid-cols-2 px-10">
            <div className="bg-circles bg-no-repeat bg-center flex justify-center items-center h-screen">
        ...
        <div className="mt-12 mb-32">
          ...
          <div className="grid grid-cols-3 gap-[74px] max-w-[1135px] mx-auto">
            {atricleCradData.map((data) => (
              <ArticleCard img={data.img} title={data.title} desc={data.desc} />
            ))}
            <div>
      ...
      <section className="bg-contact bg-cover">
        <div className="flex justify-end items-center">
          <div>
            <h2 className="text-white text-5xl font-semibold leading-[60px] mb-2">
              Contact Now and Discover <br />
              the Perfect Products!
            </h2>
            <p className="text-lg text-white mb-4">
              Lorem ipsum dolor sit amet consectetur. Justo dignissim convallis
              viverra id risus. Diam vitae consequat.
            </p>
